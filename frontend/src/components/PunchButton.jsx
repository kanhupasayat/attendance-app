...
const PunchButton = ({ type, onSuccess, disabled }) => {
  ...
  const buttonClass = type === 'in'
    ? 'bg-gradient-to-r from-green-500 to-emerald-600 hover:from-green-600 hover:to-emerald-700 disabled:from-green-300 disabled:to-emerald-400 shadow-lg shadow-green-500/30 hover:shadow-green-500/40'
    : 'bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 disabled:from-red-300 disabled:to-rose-400 shadow-lg shadow-red-500/30 hover:shadow-red-500/40';
  ...
  return (
    <>
      <button
        ...
        className={`${buttonClass} text-white font-bold py-4 px-8 rounded-xl text-lg transition-all transform hover:scale-105 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none flex items-center justify-center gap-2`}
      >
        {loading ? (
